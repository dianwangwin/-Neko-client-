package lgbt.vaimok.neko.nekohax.guiscreen.render;

import lgbt.vaimok.neko.nekohax.turok.Turok;
import lgbt.vaimok.neko.nekohax.turok.draw.RenderHelp;
import lgbt.vaimok.neko.nekohax.turok.task.Rect;
...
public class Draw {
	...
	public static void draw_string(String string, int x, int y, int r, int g, int b, int a) {
		font_renderer.drawStringWithShadow(string, x, y, new ClientColor(r, g, b, a).hex());
	}
	...
	public void draw_string_gl(String string, int x, int y, int r, int g, int b) {
		...
		font_renderer.drawString(string, x, y, new ClientColor(r, g, b).hex());

package me.neko.wurstplus.wurstplustwo.guiscreen.render.components.widgets;


import me.neko.wurstplus.turok.values.TurokDouble;
import me.neko.wurstplus.NekoHax;
import me.neko.wurstplus.wurstplustwo.guiscreen.render.WurstplusDraw;
import me.neko.wurstplus.wurstplustwo.guiscreen.render.components.WurstplusAbstractWidget;
import me.neko.wurstplus.wurstplustwo.guiscreen.render.components.WurstplusFrame;
import me.neko.wurstplus.wurstplustwo.guiscreen.render.components.WurstplusModuleButton;
...
public class WurstplusSlider extends WurstplusAbstractWidget {
	...
	public WurstplusSlider(WurstplusFrame frame, WurstplusModuleButton master, String tag, int update_postion) {
		this.frame   = frame;
		this.master  = master;
		this.setting = NekoHax.get_setting_manager().get_setting_with_tag(master.get_module(), tag);
	...
	public void render(int master_y, int separe, int absolute_x, int absolute_y) {
		...
		int ns_r = NekoHax.click_gui.theme_widget_name_r;
		int ns_g = NekoHax.click_gui.theme_widget_name_g;
		int ns_b = NekoHax.click_gui.theme_widget_name_b;
		int ns_a = NekoHax.click_gui.theme_widget_name_b;

...
public class HoleFill extends Module {
    ...
    public void find_new_holes() {
        holes.clear();
        for (BlockPos blockPos : BlockInteractHelper.getSphere(WurstplusPlayerUtil.GetLocalPlayerPosFloored(), hole_range.get_value(1), hole_range.get_value(1), false, true, 0)) {

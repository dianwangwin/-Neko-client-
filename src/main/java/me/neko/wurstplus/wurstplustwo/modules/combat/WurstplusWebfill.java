...
import me.neko.wurstplus.wurstplustwo.util.BlockInteractHelper.ValidResult;
import me.neko.wurstplus.wurstplustwo.util.WurstplusMessageUtil;
import me.neko.wurstplus.wurstplustwo.util.WurstplusPlayerUtil;
...
public class WurstplusWebfill extends Module {
    ...
    public void find_new_holes() {
        ...
        for (BlockPos pos : BlockInteractHelper.getSphere(WurstplusPlayerUtil.GetLocalPlayerPosFloored(), web_range.get_value(1), (int) web_range.get_value(1), false, true, 0)) {

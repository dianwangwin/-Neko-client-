...
public class WurstplusAutoCrystal extends WurstplusHack {
    ...
    WurstplusSetting break_trys = this.create("Break Attempts", "CaBreakAttempts", 1, 1, 6);
    ...
    WurstplusSetting hit_range = this.create("Hit Range", "CaHitRange", 5.0D, 1.0D, 6.0D);
    WurstplusSetting place_range = this.create("Place Range", "CaPlaceRange", 5.0D, 1.0D, 6.0D);
    ...
    WurstplusSetting break_delay = this.create("Break Delay", "CaBreakDelay", 1, 0, 10);
    WurstplusSetting min_player_place = this.create("Min Enemy Place", "CaMinEnemyPlace", 4, 0, 20);
    WurstplusSetting min_player_break = this.create("Min Enemy Break", "CaMinEnemyBreak", 4, 0, 20);
    WurstplusSetting max_self_damage = this.create("Max Self Damage", "CaMaxSelfDamage", 8, 0, 20);
    ...
    WurstplusSetting anti_stuck = this.create("Anti Stuck", "CaAntiStuck", true);
    ...
    WurstplusSetting faceplace_mode_damage = this.create("T Health", "CaTabbottModeHealth", 10, 0, 36);
    WurstplusSetting fuck_armor_mode = this.create("Armor Destroy", "CaArmorDestory", true);
    WurstplusSetting fuck_armor_mode_precent = this.create("Armor %", "CaArmorPercent", 10, 0, 100);

...
public class WurstplusAutoCrystal extends WurstplusHack {
    ...
    WurstplusSetting client_side = this.create("Ghost Mode", "CaClientSide", false);
    ...
    WurstplusSetting faceplace_mode = this.create("Faceplace", "CaTabbottMode", true);
    WurstplusSetting faceplace_mode_damage = this.create("FP Health", "CaTabbottModeHealth", 8, 0, 36);
                        ...
                        do {
                            do {
                                do {
                                    ...
                                    } while(player.getDistance(mc.player) >= 11.0F);
    ...
    public BlockPos get_best_block() {
        if (this.get_best_crystal() != null && !this.fast_mode.get_value(true)) {
            ...
            List damage_blocks = new ArrayList();
            double best_damage = 0.0D;
            double maximum_damage_self = (double)this.max_self_damage.get_value(1);
            BlockPos best_block = null;
            List blocks = WurstplusCrystalUtil.possiblePlacePositions((float)this.place_range.get_value(1), this.endcrystal.get_value(true), true);
                            ...
                            do {
                                do {
                                    do {
                                        ...
                                        } while(!WurstplusBlockUtil.canSeeBlock(block) && mc.player.getDistance((double)block.getX(), (double)block.getY(), (double)block.getZ()) > (double)this.hit_range_wall.get_value(1));
    ...
    public List sort_best_blocks(List list) {
        ...
        for(int i = 0; i < list.size(); ++i) {
            ...
            while(var9.hasNext()) {
                WurstplusPair pair = (WurstplusPair)var9.next();
